...
//     {}
    ...
    QRGBValue operator-() const
    {
        ...
        */
    value_type & red() { return this->data_[2]; }
    ...
    value_type & green() { return this->data_[1]; }
        ...
        */
    value_type & blue() { return this->data_[0]; }
    ...
    value_type & opacity() { return this->data_[3]; }
        ...
        /** Read red component.
        */
    value_type const & red() const { return this->data_[2]; }
    ...
    value_type const & green() const { return this->data_[1]; }
        ...
        /** Read blue component.
        */
    value_type const & blue() const { return this->data_[0]; }
